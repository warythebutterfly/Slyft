            ...
            <View>
                ...
                <View style={tw`h-1/2`}>
                    ...
                    driverLicense?.licenseExpiryDate ? (
                        <Stack.Navigator>
                            <Stack.Screen name="GiveNavigateCard" component={GiveNavigateCard} options={{ headerShown: false }} />
                            <Stack.Screen name="RiderOptionsCard" component={RiderOptionsCard} options={{ headerShown: false }} />
                        </Stack.Navigator>
                    ) : (
                        <View>
                            <Text style={tw`text-center py-5 text-xl`}>Add your vehicle information to give a ride</Text>
                            <TouchableOpacity style={tw`bg-gray-800 p-4 rounded-md mr-4 ml-4 mb-14`} onPress={() => navigation.navigate("Profile")}>
                                <Text style={tw`text-white text-center font-bold text-lg`}>Complete Profile</Text>
                            </TouchableOpacity>
                        </View>
                    )}
                </View>
