...
const LoginScreen = () => {
    ...
    return (
        <KeyboardAvoidingView behavior="padding" style={tw`flex-1 justify-center items-center p-4 bg-white`}>
            <View>
                <Text
                    style={{
                        height: 100,
            ...
            <Formik
                ...
                validationSchema={yup.object().shape({
                    email: yup
                        .string()
                        .email("Invalid email")
                        .test("unilagEmail", "Enter your student or staff email address", function (value) {
                            ...
                            if (response.data.success) {
                                ...
                                axios
                                    ...
                                    .then((response) => {
                                        ...
                                        dispatch(setUser({ ...user, token, ...response.data.data }));
            ...
            >
                {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                    <>
                        ...
                        <TouchableOpacity style={tw`bg-gray-800 p-4 rounded-md w-full mb-14`} onPress={handleSubmit} disabled={loading}>
                            {loading ? (
                        ...
                        <TouchableOpacity onPress={navigateToSignUp}>
                            <Text style={tw`text-gray-500 text-center mb-6`}>Don't have an account? Sign Up</Text>
                        </TouchableOpacity>
